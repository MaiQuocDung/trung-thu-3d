...
const wishList = [
  {
    text: "Chúc em có một mùa Trung Thu tràn ngập niềm vui, hạnh phúc và luôn có anh ở bên!",
    img: "./assets/4.jpg",
  },
  {
  ...
  {
    text: "Trăng tròn ấm áp, chúc cho tình yêu của chúng ta mãi bền chặt.",
    img: "./assets/7.jpg",
  },
  {
  ...
  {
    text: "Mong rằng em lúc nào cũng tươi cười rạng rỡ và luôn xinh đẹp như ánh trăng rằm.",
    img: "./assets/2.jpg",
  },
];
